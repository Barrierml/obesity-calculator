...
(function () {
  ...
  const I18N = {
    en: {
      ...
      label_hba1c: "Glycated Hemoglobin (HbA1c) · unit optional",
      label_TG: "Triglycerides (TG) · unit optional",
      label_HDL_C: "HDL Cholesterol (HDL-C) · unit optional",
      label_Creatinine: "Creatinine · unit optional",
    ...
    zh: {
      ...
      clearBtn: "清空",
      label_SBP: "收缩压 (SBP)",
      label_hba1c: "糖化血红蛋白 (HbA1c) · 单位可选",
      label_TG: "甘油三酯 (TG) · 单位可选",
      label_HDL_C: "高密度脂蛋白胆固醇 (HDL-C) · 单位可选",
      label_Creatinine: "肌酐 (Creatinine) · 单位可选",
      label_ALT: "谷丙转氨酶 (ALT)",
      label_Waist: "腰围 (cm)",
      label_Hip: "臀围 (cm)",
      label_WHR: "腰臀比 (WHR)",
